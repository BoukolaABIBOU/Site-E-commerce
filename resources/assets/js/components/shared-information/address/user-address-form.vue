<template>
    <form class="address-form" @submit.prevent="beforeSubmit">
        <div class="row">
            <div class="col-sm-12">
                <div :class="{'form-group': true, 'has-error' : errors.has('street_address')}">
                    <label for="street_address" class="control-label">Addresse: </label>
        ...
        <div class="row">
            <div class="col-sm-6" v-if="states">
                <div :class="{'form-group': true, 'has-error' : errors.has('state')}">
                    <label for="state" class="control-label">Etat:</label>
                    <select name="state"
                            id="state"
                            class="form-control"
                            v-validate="'required'"
        ...
        <div class="row">
            <div class="col-sm-12">
                <button class="btn btn-danger pull-right" type="button" @click="close">Annuler</button>
                <button class="btn btn-primary pull-left" type="submit">Soumettre</button>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </form>
</template>
