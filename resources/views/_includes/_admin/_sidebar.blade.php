            ...
            <ul class="nav side-menu">
                ...
                <li>
                    <a href="{{ action('Admin\ProductsController@index') }}">
                        <i class="fa fa-product-hunt" aria-hidden="true"></i>Livres
                    </a>
                </li>
                <li>
                    <a href="{{ action('Admin\OrdersController@index') }}">
                        <i class="fa fa-shopping-cart" aria-hidden="true"></i>Commandes
                    </a>
                </li>
                <li>
                    <a href="{{ action('Admin\CategoriesController@index') }}">
                        <i class="fa fa-list-alt" aria-hidden="true"></i>Catégories
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ action('Admin\StatesController@index') }}">
                        <i class="fa fa-map-o" aria-hidden="true"></i>Etats
                    </a>
                </li>
            </ul>
        </div><!-- /.menu_section -->
